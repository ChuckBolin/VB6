...
Private Sub vsb_Change()
  ...
  For i = 0 To g_nNodeCount - 1
    DrawNode g_uNode(i).x, g_uNode(i).y - m_nYpos, g_uNode(i).Name
  Next i
...
Private Sub DrawNode(x As Integer, y As Integer, sName As String)
  pic.Line (x + (0.25 * m_nNodeWidth), y - m_nYpos)-(x + (0.25 * m_nNodeWidth), y - m_nYpos - (2 * m_nNodeHeight))
  pic.Line (x, y - m_nYpos)-(x + m_nNodeWidth, y - m_nYpos + m_nNodeHeight), , B
