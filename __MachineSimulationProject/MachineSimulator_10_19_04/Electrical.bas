...
Public Const MAX_VOLTAGE_NODES = 81
Public Const V_L1 = 1
Public Const V_L2 = 2
Public Const V_L3 = 3
...
Public Sub InitializeElectrical()
  ...
  'initial switch conditions
  e(Q0_12) = True 'Main disconnect contacts closed
  e(Q0_34) = True
  e(Q0_56) = True
  e(F1_A) = True  'Main fuses good
  e(F1_B) = True
  e(F1_C) = True
...
Public Sub RefreshElectrical()
  ...
  e(T1_PRI) = e(T1_H1H2) And e(T1_H2H3) And e(T1_H3H4)
  f(T1_PRI) = f(T1_H1H2) And f(T1_H2H3) And f(T1_H3H4)
  
  'secondar voltage on transformer
  v(V_T1_X1) = v(V_T1_H1) And v(V_T1_H4) And e(T1_PRI) And Not f(T1_PRI) And e(T1_SEC) And Not f(T1_SEC) 'trans sec voltage
  v(V_T1_X2) = True
  
  v(V_120V_L1) = v(V_T1_X1) And e(F3) And Not f(F3) And v(V_T1_X2)
  ...
  v(V_S10_PROX) = v(V_BE_24V) And e(S10_PROX) And Not f(S10_PROX) And v(V_INPUT_MOD1_0V)

  v(V_S11_Z1_RETRACT) = v(V_BE_24V) And e(S11_Z1_RETRACT) And Not f(S11_Z1_RETRACT) And v(V_INPUT_MOD1_0V)
  v(V_S12_Z1_EXTEND) = v(V_BE_24V) And e(S12_Z1_EXTEND) And Not f(S12_Z1_EXTEND) And v(V_INPUT_MOD1_0V)
  v(V_S14_Z3_RETRACT) = v(V_BE_24V) And e(S14_Z3_RETRACT) And Not f(S14_Z3_RETRACT) And v(V_INPUT_MOD1_0V)
  v(V_S15_Z3_EXTEND) = v(V_BE_24V) And e(S15_Z3_EXTEND) And Not f(S15_Z3_EXTEND) And v(V_INPUT_MOD1_0V)
  v(V_S20_Z7_RETRACT) = v(V_BE_24V) And e(S20_Z7_RETRACT) And Not f(S20_Z7_RETRACT) And v(V_INPUT_MOD1_0V)
  v(V_S21_Z7_EXTEND) = v(V_BE_24V) And e(S21_Z7_EXTEND) And Not f(S21_Z7_EXTEND) And v(V_INPUT_MOD1_0V)
  ...
  IO.SetInput 8, v(V_S10_PROX)
  IO.SetInput 9, v(V_S11_Z1_RETRACT)
  IO.SetInput 10, v(V_S12_Z1_EXTEND)
  IO.SetInput 11, v(V_S14_Z3_RETRACT)
  IO.SetInput 12, v(V_S15_Z3_EXTEND)
  IO.SetInput 13, v(V_S20_Z7_RETRACT)
  IO.SetInput 14, v(V_S21_Z7_EXTEND)
