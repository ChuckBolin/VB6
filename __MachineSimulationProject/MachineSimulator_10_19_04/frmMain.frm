...
Begin VB.MDIForm frmMain 
   ...
   Begin VB.Menu mnuView 
      ...
      End
      Begin VB.Menu mnuViewSchematic 
...
Private Sub mnuViewSchematic_Click()
  If mnuViewSchematic.Checked = True Then
    mnuViewSchematic.Checked = False
    Unload frmDraw
  Else
    mnuViewSchematic.Checked = True
    frmDraw.Show
  End If
End Sub
