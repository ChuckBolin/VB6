...
Public Sub DrawResistorHor(ByVal x As Single, ByVal y As Single)
  'DrawNode x, y
  picDraw.Line (x, y)-(x + 350, y)
  picDraw.Line -(x + 400, y - 200)
  picDraw.Line -(x + 500, y + 200)
  picDraw.Line -(x + 600, y - 200)
  picDraw.Line -(x + 700, y + 200)
  picDraw.Line -(x + 800, y - 200)
  picDraw.Line -(x + 900, y + 200)
  picDraw.Line -(x + 950, y)
  picDraw.Line -(x + 1300, y)
  'DrawNode x + 1300, y
End Sub
