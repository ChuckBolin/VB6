...
Public Sub RefreshElectrical()
  ...
  If e(V_120_X2) Then e(V_120_N) = True
  If e(V_120_L1) And e(D_120_PLC_OCPD) Then e(V_120_PLC_L1) = True
  If e(V_120_N) Then e(V_120_PLC_N) = True
  g_uPLC.PowerApplied = e(V_120_PLC_L1) And e(D_120_PLC_POWER_SWITCH) And e(D_120_PLC_POWER_SUPPLY)
  e(D_PLC_INPUT_MODULE) = e(V_24_PLC_NEG)
  e(D_PLC_OUTPUT_MODULE) = e(V_24_PLC_POS)
  
  If e(D_PLC_INPUT_MODULE) Then
    IO.EnableInputs
  Else
    IO.DisableInputs
  End If
  
  If e(D_PLC_OUTPUT_MODULE) Then
    IO.EnableOutputs
  Else
    IO.DisableOutputs
  End If
  
  'frmPLC.Caption = g_uPLC.PowerApplied
