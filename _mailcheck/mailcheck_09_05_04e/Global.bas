...
Public Sub LoadGlobalVariables()
  ...
  g_uScore.BodyText = 2
  g_uScore.CountryCode = 1
  g_uScore.DateMissing = 5  'forged date if missing
  g_uScore.EmptySubject = 1
  g_uScore.FromMissing = 5  'can't trust
  g_uScore.ReceivedUnknown = 2
  g_uScore.SubjectAddon = 2
  g_uScore.Attract = 2
  g_uScore.Degree = 2
  g_uScore.Finance = 2
  g_uScore.Health = 2
  ...
  g_uScore.HWSW = 2
  g_uScore.Misc = 2
  g_uScore.SubjectNumbers = 2
  g_uScore.Porn = 2
  g_uScore.SubjectXAscii = 10 'extended ascii more than 50%
  g_uScore.SubjectConsecCount = 3
  g_uScore.DomainCount = 1  'too many of the same domain
  g_uScore.ToMissingDomain = 10
  g_uScore.ToMissingUserName = 10
  g_uScore.SpamMinimum = 10   'needs this many points to be spam
...
Public Function LookForBodyText(strIn As String) As Single
  ...
  For i = 1 To UBound(g_sBodyText)
    If InStr(1, sTemp, g_sBodyText(i)) Then
      LookForBodyText = LookForBodyText + g_uScore.BodyText 'match found
    End If
  Next i
