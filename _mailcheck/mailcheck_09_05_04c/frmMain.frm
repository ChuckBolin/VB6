        ...
        Select Case m_State
            ...
            Case POP3_RETR
                ...
                If InStr(1, strBuffer, vbLf & "." & vbCrLf) Then
                    ...
                    m_oMessage.Score = m_oMessage.Score + LookForSubjectHealth(m_oMessage.subject)
                    m_oMessage.Score = m_oMessage.Score + LookForSubjectFinance(m_oMessage.subject)
                    m_oMessage.Score = m_oMessage.Score + LookForSubjectPorn(m_oMessage.subject)
                    m_oMessage.Score = m_oMessage.Score + LookForSubjectMisc(m_oMessage.subject)
                    m_oMessage.Score = m_oMessage.Score + LookForSubjectHWSW(m_oMessage.subject)
                    m_oMessage.Score = m_oMessage.Score + LookForSubjectAttract(m_oMessage.subject)
                    m_oMessage.Score = m_oMessage.Score + LookForSubjectDegree(m_oMessage.subject)
                    m_oMessage.Score = m_oMessage.Score + LookForSubjectHoliday(m_oMessage.subject)
