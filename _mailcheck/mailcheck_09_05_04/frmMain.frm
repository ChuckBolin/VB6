...
Private Sub Command1_Click()
  'Dim i As Integer
  'txtViewAll.Text = ""
  'For i = 1 To m_colMessages.Count
  '  txtViewAll.Text = txtViewAll.Text & "*********************" & i & vbCrLf
  '  txtViewAll.Text = txtViewAll.Text & m_colMessages.Item(i) & vbCrLf
  'Next i
        ...
        Select Case m_State
            ...
            Case POP3_RETR
                ...
                If InStr(1, strBuffer, vbLf & "." & vbCrLf) Then
                    ...
                    m_oMessage.Score = 0 '0 or less is good, greater than 5
                                         'probably spam
                    
                    'specific filtering things
