...
Private Sub Form_Load()
  ...
  'UpdateStatus
  txtWhy.Text = txtWhy.Text & em(gintEmailToReview).bytes_total & vbCrLf
  txtWhy.Text = txtWhy.Text & em(gintEmailToReview).cc & vbCrLf
  txtWhy.Text = txtWhy.Text & em(gintEmailToReview).dead & vbCrLf
  txtWhy.Text = txtWhy.Text & em(gintEmailToReview).from & vbCrLf
  txtWhy.Text = txtWhy.Text & em(gintEmailToReview).messagebody & vbCrLf
  txtWhy.Text = txtWhy.Text & em(gintEmailToReview).msg_word & vbCrLf
  txtWhy.Text = txtWhy.Text & em(gintEmailToReview).sub_word & vbCrLf
  txtWhy.Text = txtWhy.Text & em(gintEmailToReview).subject & vbCrLf
  txtWhy.Text = txtWhy.Text & em(gintEmailToReview).bytes_total & vbCrLf
  txtWhy.Text = txtWhy.Text & em(gintEmailToReview).bytes_total & vbCrLf
  txtWhy.Text = txtWhy.Text & em(gintEmailToReview).bytes_total & vbCrLf
  txtWhy.Text = txtWhy.Text & em(gintEmailToReview).bytes_total & vbCrLf
