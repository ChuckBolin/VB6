...
Private Sub Form_Load()
  ...
  If em(gintEmailToReview).delete_code > 0 Then
    ...
    If (em(gintEmailToReview).delete_code And FILTER_SUB_BAD_WORDS) Then txtWhy.Text = txtWhy.Text & "Subject has Spam phrases." & vbCrLf
    ...
    If (em(gintEmailToReview).delete_code And FILTER_MSG_BAD_WORDS) Then txtWhy.Text = txtWhy.Text & "Message has Spam phrases." & vbCrLf
...
Public Sub UpdateStatus()
 'updates txtWhy textbox with message about why the spam is spam
  If em(gintEmailToReview).delete_code > 0 Then
    ...
    If (em(gintEmailToReview).delete_code And FILTER_TOO_SHORT) Then txtWhy.Text = txtWhy.Text & "Subject is too short." & vbCrLf
    If (em(gintEmailToReview).delete_code And FILTER_TOO_LONG) Then txtWhy.Text = txtWhy.Text & "Subject is too long." & vbCrLf
    If (em(gintEmailToReview).delete_code And FILTER_BAD_WORDS) Then txtWhy.Text = txtWhy.Text & "Subject has Spam phrases." & vbCrLf
    If (em(gintEmailToReview).delete_code And FILTER_TOO_MANY_CONSONANTS) Then txtWhy.Text = txtWhy.Text & "Subject has too many consonants." & vbCrLf
