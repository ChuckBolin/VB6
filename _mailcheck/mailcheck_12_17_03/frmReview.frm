...
Private mblnUpdate As Boolean 'true if filter updated
...
Private Sub Form_Load()
  ...
  If em(gintEmailToReview).delete_code > 0 Then
    ...
    txtWhy.Visible = True
    txtWhy.Text = ""
    If (em(gintEmailToReview).delete_code And 1) Then txtWhy.Text = txtWhy.Text & "Subject is too short." & vbCrLf
    If (em(gintEmailToReview).delete_code And 2) Then txtWhy.Text = txtWhy.Text & "Subject is too long." & vbCrLf
    If (em(gintEmailToReview).delete_code And 4) Then txtWhy.Text = txtWhy.Text & "Subject has Spam phrases." & vbCrLf
    If (em(gintEmailToReview).delete_code And 8) Then txtWhy.Text = txtWhy.Text & "Subject has too many consonants." & vbCrLf
