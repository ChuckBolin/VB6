...
Private Sub lstSubject_MouseDown(Button As Integer, Shift As Integer, x As Single, Y As Single)
  If Button = 2 Then
     If lstSubject.ListCount > 0 And gblnDownloadComplete = True Then PopupMenu Popup
  End If
End Sub
        ...
        Select Case m_State
            ...
            Case POP3_RETR
                ...
                If InStr(1, strBuffer, vbLf & "." & vbCrLf) Then
                    ...
                    'filter subject
                    intCode = FilterSubject(m_oMessage.subject)
                    If intCode = 0 Then
                      strMsg = "OK"
                    Else
                      strMsg = "SPAM"
                    ...
                    em(intCurrentMessage).delete_code = intCode
