...
Private Sub picField_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
  ...
  If Button = 2 Then
    ...
    If CSng(txtRecVel.Text) <> 0 Then
      f.RecDir = DtoR(CSng(txtRecDir.Text))
      f.RecVel = CSng(txtRecVel.Text)
      f.MoveReceiver
    End If
