...
Public Sub LoadBotData()
  ...
  For i = 1 To b.GetMaxBots
    ...
    bRet = b.SetX(i, 50)
    bRet = b.SetY(i, 30)
    bRet = b.AddIntermediatePos(i, 30, 60)
    bRet = b.AddIntermediatePos(i, 70, 70)
    bRet = b.SetTargetX(i, 80)
    bRet = b.SetTargetY(i, 80)
    bRet = b.SetVelocity(i, 0.5)
    'MsgBox b.GetNumIntermediatePos(i)
    'MsgBox b.GetIntermediateX(i, 1)
