...
Begin VB.Form frmMain 
   ...
   Caption         =   "Patterns v0.3 (Modified Tetris Clone) - Written by Chuck Bolin, November 2003"
   ClientHeight    =   8160
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9840
...
Private Sub NewLevel()
    ...
    pic.SetFocus
    Timer1.Interval = 700 - gintLevel * 30
    Timer1.Enabled = True
    Timer2.Enabled = True
...
Private Sub Timer1_Timer()
 ...
 ' If prow > 21 - height Then mblnBottom = True
  If mblnBottom = True Then
    ...
    ppattern1 = ppattern2
    ppattern2 = GetPattern()
    Label5.Caption = ppattern & " " & p(ppattern).color
    gintPatterns = gintPatterns + 1
    lblPatterns.Caption = gintPatterns
    porient = 1
...
Private Sub Timer2_Timer()
  ...
  If gintLevel > 0 Then
    ...
    If num > 1000000 - (CLng(gintLevel) * 10000) Then  '80 - 90% chance of happening
      val = 1 + Rnd * 18
      If (bd(18) And 2 ^ val) Then bd(18) = bd(18) Xor 2 ^ val
      If (bd(19) And 2 ^ val) Then bd(19) = bd(19) Xor 2 ^ val
      If (bd(20) And 2 ^ val) Then bd(20) = bd(20) Xor 2 ^ val
      DrawBoard
    End If
  End If
