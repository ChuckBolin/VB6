...
Begin VB.Form frmMain 
   ...
   Caption         =   "Patterns v0.4m (Modified Tetris Clone) - Written by Chuck Bolin, November 2003"
   ClientHeight    =   8160
   ClientLeft      =   150
   ClientTop       =   720
   ClientWidth     =   9840
...
Private Sub cmdDestroy_Click()
 ...
 'piece disappears
  If mblnPaused = False And mblnKey = False Then
...
Private Sub pic_KeyDown(KeyCode As Integer, Shift As Integer)
  ...
  If KeyCode = vbKeyUp And mblnPaused = False And mblnKey = True Then
  ...
  'piece disappears
  If KeyCode = vbKeySpace And mblnPaused = False And mblnKey = True Then
    ErasePattern2 CInt(prow), CInt(pcol), CInt(ppattern), CInt(porient)
    prow = 1
    pcol = (gintLevel * 2) + Rnd * (16 - (gintLevel * 3))
    ppattern = ppattern1
  ...
  If Shift = 2 And mblnKey = True Then
    mblnFast = Not mblnFast
    If mblnFast = True Then
      Timer1.Interval = 200 - gintLevel * 15
      lblTime.Caption = "Fast"
  ...
  'pauses game
  If KeyCode = vbKeyP And mblnKey = True Then
    Timer1.Enabled = Not Timer1.Enabled
    Timer2.Enabled = Not Timer2.Enabled
    mblnPaused = Not mblnPaused
  End If
  ...
  'drops part
  If KeyCode = vbKeyDown And mblnPaused = False And mblnKey = True Then
    mblnDrop = True
    Do
      Timer1_Timer
  ...
  'move to left
  If KeyCode = vbKeyLeft And mblnPaused = False And mblnKey = True Then
    If OkayLeft Then
      ErasePattern2 CInt(prow), CInt(pcol), CInt(ppattern), CInt(porient)
      pcol = pcol - 1
  ...
  'move to right
  If KeyCode = vbKeyRight And mblnPaused = False And mblnKey = True Then
    If OkayRight Then
      ErasePattern2 CInt(prow), CInt(pcol), CInt(ppattern), CInt(porient)
      pcol = pcol + 1
...
Private Sub pic_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
  ...
  'left button changes orientation...rotates counter clockwise
  If mblnPaused = False And mblnKey = False And Button = 2 Then
  ...
  'right button drops part
  If mblnPaused = False And mblnKey = False And Button = 1 Then
    mblnDrop = True
    Do
      Timer1_Timer
    Loop Until mblnDrop = False
