...
Private Sub Form_Load()
  Text1.Text = "Patterns v0.5 Help     November 13, 2003" & vbCrLf
  Text1.Text = Text1.Text & " " & vbCrLf
  Text1.Text = Text1.Text & "Keys             Mouse               Function " & vbCrLf
  Text1.Text = Text1.Text & "====            =====               =======" & vbCrLf
  Text1.Text = Text1.Text & "Up Arrow       Right Click         Rotate clockwise " & vbCrLf
  Text1.Text = Text1.Text & "Right Arrow   Mouse Right       Move pattern right " & vbCrLf
  Text1.Text = Text1.Text & "Left Arrow     Mouse Left         Move pattern left " & vbCrLf
  Text1.Text = Text1.Text & "Down Arrow  Left Click            Drop pattern down " & vbCrLf
  Text1.Text = Text1.Text & "P                 Pause Button      Pauses/unpauses game " & vbCrLf
  Text1.Text = Text1.Text & "Spacebar                               Destroys falling pattern...costs points " & vbCrLf
  Text1.Text = Text1.Text & "CTRL           Click Slow/Fast   Toggles speed to Slow (normal) or Fast 3x " & vbCrLf
  Text1.Text = Text1.Text & " " & vbCrLf
  ...
  Text1.Text = Text1.Text & " " & vbCrLf
  Text1.Text = Text1.Text & "Score = Score + ( Total Rows x Level x 10 x Consecutive Rows ) " & vbCrLf
  Text1.Text = Text1.Text & " " & vbCrLf
