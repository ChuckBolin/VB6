...
Public Type Pattern
  ...
  'there are 8 possible ways to draw relative pattern on grid
  rel As Long 'stores equivalent relative pattern
  rot90 As Long 'rotate 90, 180, 270 degrees ClockWise
  rot180 As Long
  rot270 As Long
  flip As Long 'flipping rel
  flip90 As Long 'flipping flip90
  flip180 As Long 'flipping180
  flip270 As Long 'flipping270
