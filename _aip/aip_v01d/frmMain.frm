...
Private Sub cmdShowFile_Click()
  ...
  nFile = FreeFile
  Open App.Path & "\" & gsFilename For Input As nFile
...
Private Sub cmdShowKnowledge_Click()
  ...
  sArray = sArray & "LONG      AIP Language" & vbCrLf
...
Private Sub cmdShowVariables_Click()
  ...
  sArray = sArray & "gbWinExists: " & gbWinExists & vbCrLf
...
Private Sub msgGrid_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
  ...
  If Button = 1 Then
    ...
    If msgGrid.TextMatrix(nRow, nCol) = "" And gbWinExists = False Then
    ...
    ElseIf msgGrid.TextMatrix(nRow, nCol) = gsTeacherSymbol And gbWinExists = True And msgGrid.CellBackColor <> glCellSelectedColor Then
