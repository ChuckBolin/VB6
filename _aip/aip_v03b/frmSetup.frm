...
Private Sub cmdSetup_Click()
  ...
  'don't allow for game type 2
  If hsbGameType = 2 Then
    MsgBox AI.FullName & " " & AI.Version & " does not support Type 2 games."
    Exit Sub
  End If
