...
Public Sub LoadVariables()
 ...
 GPS(3).A.X = 16000: GPS(3).A.Y = 13000: GPS(3).B.X = 21000: GPS(3).B.Y = 10000: GPS(3).Num = 3
 GPS(4).A.X = 11000: GPS(4).A.Y = 13000: GPS(4).B.X = 16000: GPS(4).B.Y = 9000: GPS(4).Num = 0

 'route 2
 leg(1).X1 = 10000: leg(1).Y1 = 10000: leg(1).X2 = 10000: leg(1).Y2 = 14000: leg(1).Width = 300: leg(1).Orientation = 1
 leg(2).X1 = 10000: leg(2).Y1 = 14000: leg(2).X2 = 12500: leg(2).Y2 = 14000: leg(2).Width = 200: leg(2).Orientation = 2
 leg(3).X1 = 12500: leg(3).Y1 = 14000: leg(3).X2 = 12500: leg(3).Y2 = 16000: leg(3).Width = 100: leg(3).Orientation = 1
 leg(4).X1 = 12500: leg(4).Y1 = 16000: leg(4).X2 = 17500: leg(4).Y2 = 16000: leg(4).Width = 100: leg(4).Orientation = 2
 leg(5).X1 = 17500: leg(5).Y1 = 16000: leg(5).X2 = 17500: leg(5).Y2 = 12000: leg(5).Width = 200: leg(5).Orientation = 3
 leg(6).X1 = 17500: leg(6).Y1 = 12000: leg(6).X2 = 12000: leg(6).Y2 = 12000: leg(6).Width = 200: leg(6).Orientation = 4
 leg(7).X1 = 12000: leg(7).Y1 = 12000: leg(7).X2 = 12000: leg(7).Y2 = 10000: leg(7).Width = 300: leg(7).Orientation = 3
 leg(8).X1 = 12000: leg(8).Y1 = 10000: leg(8).X2 = 10000: leg(8).Y2 = 10000: leg(8).Width = 300: leg(8).Orientation = 4
