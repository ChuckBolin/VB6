...
Begin VB.Form frmMain 
   ...
   Caption         =   "Robot Navigation v0.11 October 13, 2005 - By Chuck Bolin"
   ClientHeight    =   10365
   ClientLeft      =   525
   ClientTop       =   480
   ClientWidth     =   13890
...
Private Sub tmrUpdate_Timer()
  ...
  picLR.ForeColor = vbWhite
  picLR.Line (1000, 0)-(1000, 1000)
  picLR.ForeColor = vbRed
  picLR.Line (1000 - leg(g_nLegNum).Width / 2, 0)-(1000 - leg(g_nLegNum).Width / 2, 1000)
  ...
  For i = 0 To 100
    ...
    If nRng < 2000 Then
      ...
      If nAng < 1.57 And nAng > -1.57 Then
        ...
        picLR.Circle (1000 + DX, DY), g_uOb(i).Radius / 2
      End If
    End If
  Next i
