...
Private Sub cmdTranslate_Click()
  ...
  'sReturn = txtC
  'MsgBox InStr(1, sReturn, "/*")
  'uPair = FindMatchingPair(InStr(1, sReturn, "/*"), "/*", "*/", sReturn)
  'uPair = FindMatchingPair(InStr(1, sReturn, "{"), "{", "}", sReturn)
  'MsgBox Mid(sReturn, uPair.First, uPair.Second - uPair.First + 2)
  sReturn = txtC
  ...
  'sReturn = C_IncrementVariable(sReturn)
  'If Left(sReturn, 5) = "ERROR" Then txtVM = sReturn: Exit Sub
